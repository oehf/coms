...
<%
	...
	if (context.equalsIgnoreCase("activatepage")) {
...
<img src="images/horizontaldashedseperator.gif"	style="margin-top: 5px; margin-bottom: 15px;">
	<div id="form">
		<form action="DeActivateMemberServiceServlet?type=<%=type%>" method="POST">
			<table border="0" style="margin-left:120px;">
				...
				<tr>
					<td><p style="margin-bottom:5px;">Geburtsdatum:</p></td> <td><input style="margin-bottom:5px;" type="text" name="birthdate" value=<%=displaysdf.format(user1.getBirthdate()) %> readonly/></td>
				</tr>
				<tr>
				...
				<tr>
					<td><input style="margin-right:15px; margin-left:15px; margin-top:5px;" class="mybutton" type="submit" value=<%=button%> /></td> <td><input style="margin-right:15px; margin-left:15px; margin-top:5px;" class="mybutton" type="button" value="Abbrechen" onclick="window.location.href='<%=request.getContextPath().toString()%>/UserDispatcher?type=homespage'"></td>
				</tr>
			</table>
		</form>
	</div>
